...
<div class="container">
    ...
    $sql = "SELECT supplierid,companyname,contactlastname,contactfirstname,phone FROM supplier";
...
<form method="post" action="result.php">
    <div class="form-group">
        ...
        <input type="text" class="form-control form-control-lg" name="query" placeholder="SELECT * FROM TABLE">
